...
The public API lives at the module root (`github.com/go-ruby-kafka/kafka`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `kafka`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-kafka/kafka](https://pkg.go.dev/github.com/go-ruby-kafka/kafka)**

The module's [README](https://github.com/go-ruby-kafka/kafka#readme) carries worked
