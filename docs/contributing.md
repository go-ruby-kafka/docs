...
Contributions are welcome. `go-ruby-kafka/kafka` is built to a small set of
...
The library is in [`github.com/go-ruby-kafka/kafka`](https://github.com/go-ruby-kafka/kafka).
This documentation site is in [`github.com/go-ruby-kafka/docs`](https://github.com/go-ruby-kafka/docs).
